...
- [ ] **Phase 1: 현재 구현과 검증 범위 확인** - 문서 계약을 실제 구현·테스트 근거와 연결한다.
- [ ] **Phase 2: 공개 문서 관리 흐름** - 기존 Web에서 관리 수명주기와 공개 접근 모델을 검증하고 차이를 보완한다.
...
|-------|----------------|--------|-----------|
| 1. 현재 구현과 검증 범위 확인 | 0/TBD | Not started | - |
| 2. 공개 문서 관리 흐름 | 0/TBD | Not started | - |
